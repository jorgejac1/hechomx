/**
 * @fileoverview Adjacent image preloading hook
 * Preloads images before and after the current index for smoother gallery navigation
 * @module hooks/common/useImagePreloader
 */
