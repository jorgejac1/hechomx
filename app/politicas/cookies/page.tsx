      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <div className="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-start gap-3 mb-3">
                <Settings className="w-6 h-6 text-blue-600 dark:text-blue-400 shrink-0 mt-1" />
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">
            ...
            <div className="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-start gap-3 mb-3">
                <Shield className="w-6 h-6 text-purple-600 dark:text-purple-400 shrink-0 mt-1" />
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <div className="prose prose-gray max-w-none text-gray-700 dark:text-gray-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <h4 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Google Chrome</h4>
                  <p className="text-sm">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <h4 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Safari</h4>
                  <p className="text-sm">
