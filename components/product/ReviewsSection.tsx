...
export default function ReviewsSection({
  ...
  return (
    <div id="reviews" className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 lg:p-8">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">
        Reseñas de Clientes
      </h2>

      {/* Enhanced Rating Summary */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 pb-8 border-b border-gray-200 dark:border-gray-700">
        {/* Overall Rating */}
        <div>
      ...
      {showReviewModal && (
        <>
          ...
          {/* Modal */}
          <div className="fixed inset-4 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-2xl bg-white dark:bg-gray-800 rounded-xl shadow-2xl z-50 flex flex-col max-h-[90vh]">
            {/* Header */}
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500"
                    disabled={isSubmittingReview}
                  />
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
                    Agrega hasta 5 fotos del producto
                  </p>
                  ...
                  {newReviewPhotos.length < 5 && (
                    <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/20 transition cursor-pointer">
            ...
            <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
              <div className="flex gap-3">
                <button
                  onClick={handleCloseReviewModal}
                  disabled={isSubmittingReview}
                  className="flex-1 px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancelar
                </button>
                <button
