  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        />
        <p className="text-xs text-gray-500 mt-1">{personalStory.length}/500 caracteres</p>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-none"
        />
        <p className="text-xs text-gray-500 mt-1">{productionProcess.length}/300 caracteres</p>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-none"
        />
        <p className="text-xs text-gray-500 mt-1">{dailyLife.length}/250 caracteres</p>
      </div>
