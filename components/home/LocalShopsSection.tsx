        ...
        <div className="mb-6">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="px-4 py-2 bg-gray-200 text-gray-900 rounded-full text-sm font-semibold hover:bg-gray-300 transition"
            >
              Inspírate
            </Link>
            <button
              onClick={handleChangeLocation}
              className="px-4 py-2 border-2 border-gray-300 text-gray-700 rounded-full text-sm font-semibold hover:border-gray-400 transition flex items-center gap-2"
            >
          ...
          {localShops.map((shop, index) => {
            ...
            return (
              <Link
                ...
                style={{ minHeight: isLarge ? '380px' : '185px' }}
              >
                {/* Background Image */}
                ...
                <div className="relative h-full flex flex-col justify-between p-4">
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <button
                      ...
                      className="ml-auto w-9 h-9 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-md"
                      aria-label="Favorito"
                    >
                  ...
                  <div className="text-white">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="relative w-12 h-12 rounded-full overflow-hidden border-3 border-white shadow-md flex-shrink-0">
                        <Image
                          src={shop.logo}
                          alt={`${shop.name} logo`}
                          fill
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-white/90">{shop.specialty}</p>
                      </div>
                    </div>
