...
export default function AboutSection() {
  return (
    <>
      <section className="bg-amber-50 dark:bg-gray-800 py-8 sm:py-10 md:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Header - Mobile Optimized */}
          <div className="text-center mb-6 sm:mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2 sm:mb-3 md:mb-4">
              ¿Qué es Papalote Market?
            </h2>
            <Link
              href="/nosotros"
              className="text-sm sm:text-base text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium underline"
            >
          ...
          <div className="text-center">
            <p className="text-base sm:text-lg md:text-xl text-gray-900 dark:text-gray-100 mb-3 sm:mb-4">
              ¿Tienes alguna pregunta? Tenemos respuestas.
            </p>
            <Link
              href="/ayuda"
              className="inline-block px-6 sm:px-8 py-2.5 sm:py-3 border-2 border-gray-900 dark:border-gray-300 rounded-full text-sm sm:text-base text-gray-900 dark:text-gray-100 font-semibold hover:bg-gray-900 dark:hover:bg-gray-700 hover:text-white transition"
            >
      ...
      <section className="bg-blue-100 dark:bg-blue-900/30 py-8 sm:py-10 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-900 dark:text-gray-100 mb-4 sm:mb-5 md:mb-6 max-w-4xl mx-auto px-4">
            ...
            <form className="max-w-3xl mx-auto flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center justify-center">
              <input
                ...
                className="w-full sm:flex-1 px-4 sm:px-5 md:px-6 py-3 sm:py-3.5 md:py-4 rounded-full border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:border-primary-500 focus:outline-hidden text-sm sm:text-base"
              />
              <button
                type="submit"
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-3.5 md:py-4 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 rounded-full text-sm sm:text-base font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition whitespace-nowrap"
              >
                Suscribirse
              </button>
            </form>
      ...
      <section className="bg-amber-50 dark:bg-gray-800 py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 sm:gap-3 text-gray-700 dark:text-gray-300">
              <svg
