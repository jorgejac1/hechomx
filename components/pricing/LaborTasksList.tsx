    ...
    <div className="bg-white rounded-xl shadow-md p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-bold text-gray-900">Tiempo de Trabajo</h2>
        </div>
        <button
          onClick={onAdd}
        ...
        {laborTasks.map((task) => (
          ...
          >
            <div className="col-span-12 sm:col-span-5">
              <label className="block text-xs text-gray-600 mb-1">Tarea</label>
              <input
                type="text"
                value={task.taskName}
            ...
            <div className="col-span-4 sm:col-span-2">
              <label className="block text-xs text-gray-600 mb-1">Tarifa/hr</label>
              <input
                type="number"
            ...
            <div className="col-span-4 sm:col-span-3 flex items-end gap-2">
              <div className="flex-1">
                ...
                <p className="text-sm font-bold text-green-600 px-2 py-1">
      ...
      <div className="mt-4 p-3 bg-green-50 rounded-lg flex items-center justify-between">
        <span className="text-sm font-semibold text-gray-700">Total Mano de Obra:</span>
